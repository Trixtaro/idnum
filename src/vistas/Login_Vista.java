...
public class Login_Vista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SISTEMA DE IDENTIFICACION DE NUMEROS");
        ...
        buttonGroup1.add(radio_jugador);
        radio_jugador.setSelected(true);
        radio_jugador.setText("Jugador");

        buttonGroup1.add(radio_administrador);
